...
DEFAULT_TRIGGERS = {
    ...
    "run-device": ["запусти устройство", "запусти устройства", "запуск устройства", "включи устройство", "включение устройства", 'включи свет'],
    "stop-device": ["останови устройство", "выключи устройство", "отключи устройство", "выключение устройства",
                    "отключение устройства", 'выключи свет', 'отключи свет', 'отключи лампу']
}
