    ...
    **Публичные методы класса:**
    ...
    def __init__(self):
        ...
        self.features = Response(
            text=("Я могу сказать дату и время, узнать курс валют или погоду, работать с заметками и сценариями, "
                  "а также управлять умными устроствами. Подробнее можете уточнить на сайте")
        )
